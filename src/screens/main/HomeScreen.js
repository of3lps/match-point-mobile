...
const GameCard = ({ title, court, time, level, image, isPartner }) => (
  <View className="flex-row gap-4 bg-surface-dark p-4 rounded-2xl mb-4 border border-white/5 shadow-sm">
    ...
    <View className="justify-between items-end gap-2">
       ...
       <TouchableOpacity className="w-10 h-10 rounded-full bg-white/5 items-center justify-center hover:bg-primary transition-colors">
    ...
    <SafeAreaView className="flex-1 bg-background-dark edges={['top']}">
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View className="px-5 pb-24">
          ...
          {/* Destaque (Clube Parceiro) - Clicável */}
          <TouchableOpacity 
            activeOpacity={0.9}
